...
def main():
    ...
    st.set_page_config(page_title="GURU AI demo", page_icon="https://haystack.deepset.ai/img/HaystackIcon.png")
    ...
    st.markdown(
            """
    Based on the FAR pdf booklet, this demo will answer any questions you have about
